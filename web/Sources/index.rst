.. ----------------------------------------------------------------------------
.. Title:   Simple rules and complex patterns
.. Author:  Jeremy Fix
.. Date:    May 2017
.. License: GNU GPL v3
.. ----------------------------------------------------------------------------
.. default-role:: math
.. meta::
   :description: Simple rules for complex patterns
...
**Forewords**
This page is written in |ReST|_ format and generated with the script `rst2html.py`_ by David Googder using the docutils_ package. The stylesheet `main.css`_ is adapted from the one used in the book |fptn|_.
...
.. |fptn| replace:: from python to numpy
.. _fptn: http://www.labri.fr/perso/nrougier/from-python-to-numpy/
.. _rst2html.py: http://docutils.sourceforge.net/tools/rst2html.py
.. _main.css: main.css




.. include:: reactionDiffusion.rst
.. include:: chaosgame.rst
